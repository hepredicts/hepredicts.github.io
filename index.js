...
var desportos = [
    { nome: "Futebol", jogos: [
        ...
        // Adicione mais jogos conforme necessário para o desporto de futebol
    ] },
    { nome: "Basquete", jogos: [
        // Jogos para o desporto de basquete
    ] },
    { nome:"Ice hockey",jogos: [
        {campeonato:"Asobal",equipe1:"Armada",equipe2:"Albacete",palpite:"Albacete",odds:1.45,resultado:"-"}
        ]},
    { nome:"Handball",jogos:[
        {campeonato:"ESO",equipe1:"Ulm",equipe2:"Biel",palpite: "Over",odds:1.53,resultado:"-"}
        ]},
{ nome:"Handball",jogos:[
        {campeonato:"ESO",equipe1:"Ulm",equipe2:"Biel",palpite: "Over",odds:1.53,resultado:"-"}
        ]},
